<!--
  ...
  Origin: corpus message #32, sub-message [361], 2026-08-12
  Verbatim source: knowledge-base/sources/message-032-original-part1.md
  Status in corpus: final publication form of the RFC-0072 CRCP Wire Format v1.6 ratification record (Status: "Ratified (Effective upon ratification of RFC-0071)"; provisional-effectiveness dependency note; ratified components with corrected parentheses; Current Red/Cognition RFC Status table — snapshot conflicts with corpus ratification events per C-19, preserved verbatim; Registry Governance; Protocol Evolution Policy; Change Control; Normative References; Related Specifications; Conformance Profile). Identical presentations [363]/[365] — D-101; updated revision of [353] (msg#31): adds the Status-line effectiveness qualifier, corrects the two stray closing parentheses (closing the X-140 observation), and renders lists/tables compactly. Approvals: [362] "Approved for publication", [364], [366] acknowledgement, [368] "READY FOR PUBLICATION" + Publication Record (after USER directive [367] "READY"). Supersedes the [353]-based scaffold of msg#31; earlier forms [339] (msg#30) and [341]–[359] retained in archive (D-99/D-100 lineage).
