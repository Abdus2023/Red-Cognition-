<!--
  ...
  Origin: corpus message #27, sub-message [291], 2026-08-11
  Verbatim source: knowledge-base/sources/message-027-original-part*.md
  Status in corpus: ratification record for RFC-0059 CTSTP v1.1 ("Status: Ratified"; "hereby ratified as a normative specification"). Identical to [293]; [281] is a divergent variant differing only in the RFC-0012 status cell (Candidate vs Ratified; D-91). Status table omits RFC-0049..0052 and lists RFC-0046/0047 as "Final Candidate" although ratification events exist (C-16 pattern; cf. C-13/C-14). Declares next phase RFC-0060 CVM-IESS.
