...
| RFC-0065 | CPCPF — Cognitive Proof-Carrying Artifact Format | v1.0 Draft ([309]; acronym shared with RFC-0033 CPCPF — C-11 naming lineage; parent header cites RFC-0064 "v1.1 (Candidate)" although only v1.0 exists in corpus — quirk preserved); review [310] requires 7 ratification clarifications (CognitiveArtifactIdentity, CPCP container 0x43504350, ArtifactTrustLevel, ProofBundle, delegation rules, BuildMetadata, loading lifecycle); no v1.1 document in corpus; no ratification decision | [`rfcs/RFC-0065-cpcpf-proof-carrying-artifact-format.md`](../../rfcs/RFC-0065-cpcpf-proof-carrying-artifact-format.md) (v1.0 Draft) |
| RFC-0066 | CPRDP — Cognitive Package Registry and Distribution Protocol | v1.0 Draft ([311]; operational registry/distribution protocol alongside RFC-0034 CPR-TDP); review/expansion [312] (PackageID = hash identity, RegistryState, CREATE→…→AUDIT lifecycle, CognitivePackageManifest, deterministic resolution, trust graph, federation rules, security chain); no ratification decision | [`rfcs/RFC-0066-cprdp-package-registry-distribution.md`](../../rfcs/RFC-0066-cprdp-package-registry-distribution.md) (v1.0 Draft) |
| RFC-0067 | CPM-WS — Cognitive Package Manager and Workspace Specification | v1.0 Draft ([313]; title echoes ratified RFC-0047 CPMWS — overlap acknowledged in [313] §12 "Previous workspace concepts"; workspace model, manifests, deterministic resolution, lockfile, reproducibility, policies, mirrors, `cog` CLI, lifecycle events); no ratification decision | [`rfcs/RFC-0067-cpm-ws-package-manager-workspace.md`](../../rfcs/RFC-0067-cpm-ws-package-manager-workspace.md) (v1.0 Draft) |
