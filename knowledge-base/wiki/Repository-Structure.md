...
## Message #27 update — rfcs/ populated with RFC-0060…RFC-0062; RFC-0059 updated (2026-08-11)

`rfcs/` now contains **75 files**: 62 RFC documents (RFC-0001…RFC-0062) + 13 ratification records (RFC-0001, RFC-0002, RFC-0011, RFC-0042, RFC-0049, RFC-0050, RFC-0052, RFC-0053, RFC-0057, RFC-0058, RFC-0059, RFC-0060, RFC-0061). Changes: RFC-0059 updated to ratified v1.1 ([280]) + new RFC-0059-ratification-record.md ([291]); new RFC-0060-cvm-iess-instruction-execution-scheduling.md ([284] v1.1) + RFC-0060-ratification-record.md ([285]); new RFC-0061-cisa-ra-instruction-set-register-architecture.md ([299] v1.2) + RFC-0061-ratification-record.md ([300]); new RFC-0062-cvm-bf-bytecode-format-encoding.md ([288] v1.0 Draft) — documented placement per RC-000 §8, byte-exact from archive.
