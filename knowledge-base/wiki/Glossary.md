...
| **CRAIP (RFC-0053)** | Cognitive Remote Agent Invocation Protocol — deterministic, capability-aware remote agent invocation across process/machine/organization boundaries; invocation state machine; transport-independent. v1.0 [237] → v1.1 Candidate [239]. | [236], [237], [239] |
