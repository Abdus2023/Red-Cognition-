...
check(7, 'README: 28 messages processed; current totals (1777 / 12 specs / 75 rfcs)',
      '28 messages processed' in readme and all(s in readme for s in [
          '**1777 code snippets**', '**12 scaffolded documents in `specs/`**', '**75 files in `rfcs/`**']))
...
check(8, 'register rows 1..28 contiguous', reg == list(range(1, 29)), str(reg))
