...
|---|---|---|
| CONFLICT-0075-001 | RFC-0075 title/§§1–14 vs §§15–19 | **RESOLVED 2026-08-13.** Later sections called the protocol **CADFP** (the RFC-0054 acronym) — a copy artifact flagged by review [420]. The four body occurrences (former §§15–19) were corrected to **CFCKEP**; the verbatim archive retains the original. |
